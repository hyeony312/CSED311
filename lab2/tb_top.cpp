...
int main(int argc, char** argv, char** env) {
    ...
    // string filename = "C:/cygwin64/home/seung/aLab2/Lab2/student_tb/answer_basic.txt";
    string filename = "C:/cygwin64/home/seung/lab4-1/student_tb/answer_non-controlflow.txt";
    ...
    for (int i = 0; i < 32; i = i + 1) {
        ...
        if (reg_hex == answer_reg) {
            ...
            cout << " (Wrong) expected: " << answer_reg << endl;
        }
    }

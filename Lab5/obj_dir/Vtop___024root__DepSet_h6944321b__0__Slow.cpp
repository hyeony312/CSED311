...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__cpu__DOT__ID_EX_mem_rw = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__ID_EX_is_input_valid = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__cpu__DOT__EX_MEM_mem_rw = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__EX_MEM_is_input_valid = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__cpu__DOT__ctrl_unit__DOT__mem_rw = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__ctrl_unit__DOT__is_input_valid = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__cpu__DOT__cache__DOT__offset = VL_RAND_RESET_I(2);
    ...
    vlSelf->top__DOT__cpu__DOT__cache__DOT__mem_input_valid = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(128, vlSelf->top__DOT__cpu__DOT__cache__DOT__cache_update_data);
    vlSelf->top__DOT__cpu__DOT__cache__DOT___mem_read = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__cache__DOT___mem_write = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__cpu__DOT__cache__DOT__current_state = VL_RAND_RESET_I(3);
    vlSelf->top__DOT__cpu__DOT__cache__DOT__next_state = VL_RAND_RESET_I(3);
    ...
    vlSelf->top__DOT__cpu__DOT__cache__DOT__is_valid = VL_RAND_RESET_I(16);
    vlSelf->top__DOT__cpu__DOT__cache__DOT__is_dirty = VL_RAND_RESET_I(16);
    vlSelf->top__DOT__cpu__DOT__cache__DOT__cache_update = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__cache__DOT__cache_update_tag = VL_RAND_RESET_I(24);

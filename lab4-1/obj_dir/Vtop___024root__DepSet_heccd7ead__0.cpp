...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    IData/*31:0*/ __Vdly__top__DOT__cpu__DOT__pc__DOT__pc_reg;
    __Vdly__top__DOT__cpu__DOT__pc__DOT__pc_reg = 0;
    ...
    // Body
    __Vdly__top__DOT__cpu__DOT__pc__DOT__pc_reg = vlSelf->top__DOT__cpu__DOT__pc__DOT__pc_reg;
    ...
    if (vlSelf->reset) {
        ...
        __Vdly__top__DOT__cpu__DOT__pc__DOT__pc_reg = 0U;
        ...
        if (vlSelf->top__DOT__cpu__DOT__pc_write) {
            __Vdly__top__DOT__cpu__DOT__current_pc 
                = ((IData)(4U) + vlSelf->top__DOT__cpu__DOT__current_pc);
            __Vdly__top__DOT__cpu__DOT__pc__DOT__pc_reg 
                = ((IData)(4U) + vlSelf->top__DOT__cpu__DOT__current_pc);
        } else {
            __Vdly__top__DOT__cpu__DOT__current_pc 
    ...
    vlSelf->top__DOT__cpu__DOT__pc__DOT__pc_reg = __Vdly__top__DOT__cpu__DOT__pc__DOT__pc_reg;
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__2(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->top__DOT__cpu__DOT__stall) {
        vlSelf->top__DOT__cpu__DOT__mem_read = 0U;
        vlSelf->top__DOT__cpu__DOT__mem_write = 0U;
        vlSelf->top__DOT__cpu__DOT__reg_write = 0U;
    }

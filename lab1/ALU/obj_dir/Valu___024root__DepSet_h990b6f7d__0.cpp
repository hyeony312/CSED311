...
VL_INLINE_OPT void Valu___024root___ico_sequent__TOP__0(Valu___024root* vlSelf) {
    ...
    // Body
    if ((0U == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = (0xffffU & ((IData)(vlSelf->A) 
                                + (IData)(vlSelf->B)));
        vlSelf->OverflowFlag = ((0U == VL_SHIFTR_III(32,32,32, 
                                                     ((IData)(vlSelf->A) 
                                                      ^ (IData)(vlSelf->B)), 0xfU)) 
                                & (1U == VL_SHIFTR_III(32,32,32, 
                                                       ((IData)(vlSelf->A) 
                                                        ^ (IData)(vlSelf->C)), 0xfU)));
    } else if ((1U == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = (0xffffU & ((IData)(vlSelf->A) 
                                - (IData)(vlSelf->B)));
        vlSelf->OverflowFlag = ((1U == VL_SHIFTR_III(32,32,32, 
                                                     ((IData)(vlSelf->A) 
                                                      ^ (IData)(vlSelf->B)), 0xfU)) 
                                & (1U == VL_SHIFTR_III(32,32,32, 
                                                       ((IData)(vlSelf->A) 
    ...
    } else if ((3U == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = (0xffffU & (~ (IData)(vlSelf->A)));
        vlSelf->OverflowFlag = 0U;
    } else if ((4U == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = ((IData)(vlSelf->A) & (IData)(vlSelf->B));
        vlSelf->OverflowFlag = 0U;
    } else if ((5U == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = ((IData)(vlSelf->A) | (IData)(vlSelf->B));
        vlSelf->OverflowFlag = 0U;
    } else if ((6U == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = (0xffffU & (~ ((IData)(vlSelf->A) 
                                   & (IData)(vlSelf->B))));
        vlSelf->OverflowFlag = 0U;
    } else if ((7U == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = (0xffffU & (~ ((IData)(vlSelf->A) 
                                   | (IData)(vlSelf->B))));
        vlSelf->OverflowFlag = 0U;
    } else if ((8U == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = ((IData)(vlSelf->A) ^ (IData)(vlSelf->B));
        vlSelf->OverflowFlag = 0U;
    } else if ((9U == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = (0xffffU & (~ ((IData)(vlSelf->A) 
                                   ^ (IData)(vlSelf->B))));
        vlSelf->OverflowFlag = 0U;
    } else if ((0xaU == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = (0xffffU & VL_SHIFTL_III(16,16,32, (IData)(vlSelf->A), 1U));
        vlSelf->OverflowFlag = 0U;
    } else if ((0xbU == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = (0xffffU & VL_SHIFTR_III(16,16,32, (IData)(vlSelf->A), 1U));
        vlSelf->OverflowFlag = 0U;
    } else if ((0xcU == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = (0xffffU & VL_SHIFTL_III(16,16,32, (IData)(vlSelf->A), 1U));
        vlSelf->OverflowFlag = 0U;
    } else if ((0xdU == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = (0xffffU & VL_SHIFTRS_III(16,16,32, (IData)(vlSelf->A), 1U));
        vlSelf->OverflowFlag = 0U;
    } else if ((0xeU == (IData)(vlSelf->FuncCode))) {
        vlSelf->C = (0xffffU & ((IData)(1U) + (~ (IData)(vlSelf->A))));
        vlSelf->OverflowFlag = 0U;
    } else {
        vlSelf->C = 0U;
        vlSelf->OverflowFlag = 0U;
